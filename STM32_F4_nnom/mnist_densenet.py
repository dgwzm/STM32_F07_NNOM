...
def main(weights='weights.h'):
    ...
    print(x_train.shape, 'train samples')   #60000, 28, 28, 1
    print(y_train.shape, 'y_train samples')#60000,
    print(x_test.shape, 'test samples')       #10000, 28, 28, 1

    # Convert class vectors to binary class matrices.
    y_train = tf.keras.utils.to_categorical(y_train, num_classes)
    y_test = tf.keras.utils.to_categorical(y_test, num_classes)
    print(y_train.shape, 'to_categorical y_train samples')#60000, 10
    print(y_test.shape, 'to_categorical y_test samples')    #10000, 10
